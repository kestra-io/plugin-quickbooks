    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.quickbooks.QuickbooksTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class QuickbooksTask extends Task implements RunnableTask<QuickbooksTask.Output> {
    @Schema(
    ...
    @Override
    public QuickbooksTask.Output run(RunContext runContext) throws Exception {
